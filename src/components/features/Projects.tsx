...
export function Projects() {
  ...
  // We have 1 Title Block + 2 Project Blocks = 3 Blocks.
  // Each block will take 100vw width, so total width is 300vw.
  // To scroll to the end, we move x by -200vw, which is -66.666% of the 300vw container.
