    ...
    <AnimatePresence>
      {isPlayerOpen && (
        ...
        >
          ...
          <div className="absolute inset-0 z-0 cursor-pointer" onClick={togglePlayer} />
                ...
                {tracks.map((t, index) => {
                  ...
                  return (
                    <div 
                      ...
                      className={`flex items-center justify-between p-3 rounded-xl cursor-pointer transition-colors group ${isActive ? 'bg-white/10' : 'hover:bg-white/5'}`}
                    >
