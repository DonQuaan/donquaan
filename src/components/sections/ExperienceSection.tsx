...
const experiences = [
  {
    role: "Quản trị viên Fanpage",
    company: "Coach Nguyễn Tú Oanh",
    duration: "Hiện tại",
    description: "Quản lý và phát triển Fanpage (có tích xanh) với hơn 130.000 người theo dõi. Lên chiến lược nội dung, tương tác và mở rộng tầm ảnh hưởng của cộng đồng.",
    link: "https://www.facebook.com/NguyenTuOanhLifecoach"
  },
  {
    role: "Cựu CEO",
    company: "Server Discord Sangtraan",
    duration: "9 Tháng (Tháng 4/2025 - Hiện tại)",
    description: "Điều hành tổng thể cộng đồng Discord quy mô lớn của Youtuber Sangtraan (700k+ subs). Đảm nhiệm các vai trò trọng yếu: Senior Chief Executive Officer, Network Ambassador, Systems Tester & Developer, Community Administrator.",
    link: "https://www.youtube.com/@Sangtraan"
  },
  {
    role: "Quản trị viên Group",
    company: "Sống hạnh phúc mỗi ngày",
    duration: "Hiện tại",
    description: "Điều hành và kiểm duyệt nội dung group cộng đồng. Xây dựng môi trường giao lưu tích cực, mang lại giá trị thực tế cho hàng ngàn thành viên.",
