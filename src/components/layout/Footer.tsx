    ...
    <footer id="contact" className="relative py-20 px-6 bg-background z-20 border-t border-white/5">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center lg:items-start justify-between gap-12">
          ...
          <div className="flex flex-col gap-4 text-sm text-muted-foreground">
            ...
            <div className="flex items-center gap-4 mt-2 p-4 rounded-2xl bg-white/5 border border-white/10 w-fit mx-auto lg:mx-0 hover:bg-white/10 transition-colors">
              <div className="bg-white p-1.5 rounded-xl shrink-0">
                <img src="/zalo-qr.jpg" alt="Zalo QR Code" className="w-16 h-16 object-contain rounded-lg" />
              </div>
        ...
        <div className="grid grid-cols-4 sm:grid-cols-4 gap-4 md:gap-6 lg:max-w-md w-full justify-items-center lg:justify-items-end lg:mt-0 mt-8">
          <a href="https://www.facebook.com/NguyenDonQuaan" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="p-3.5 w-12 h-12 rounded-full bg-white/5 hover:bg-[#1877F2] text-foreground transition-all hover:-translate-y-1 flex items-center justify-center">
          ...
          <a href="https://x.com/DonquaanN74404" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="p-3.5 w-12 h-12 rounded-full bg-white/5 hover:bg-white/20 text-foreground transition-all hover:-translate-y-1 flex items-center justify-center">
          ...
          <a href="https://www.youtube.com/channel/UCvqlcKf1nm9i2LeH9hFQQYA" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="p-3.5 w-12 h-12 rounded-full bg-white/5 hover:bg-[#FF0000] text-foreground transition-all hover:-translate-y-1 flex items-center justify-center">
          ...
          <a href="https://github.com/DonQuaan" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="p-3.5 w-12 h-12 rounded-full bg-white/5 hover:bg-white/20 text-foreground transition-all hover:-translate-y-1 flex items-center justify-center">
